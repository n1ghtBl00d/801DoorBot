...
async def unlock(interaction: nextcord.Interaction, lock_after: str = nextcord.SlashOption(description="Optional: Time to auto-lock (e.g. '1:30pm', '2h', '30m')", required=False, default="1:00AM")):
    try:
